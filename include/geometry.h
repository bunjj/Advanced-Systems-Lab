...
static std::ostream& operator<<(std::ostream& out, const m44& m) {
    int width = 8;
 ...
 * Calculates m * v
 */
static vec4 m44_mul_vec(m44 m, vec4 v) {
...
static m44 get_rot_matrix(vec rot) {
 ...
 */
static m44 get_transf_matrix(vec pos, vec rot) {
