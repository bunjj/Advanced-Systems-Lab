...
namespace impl::vec3 {
     ...
     */
    static inline void sphere_distance_vectorized(
        int idx, float* res, float* center_x, float* center_y, float* center_z, float* radius, const vec from) {
        INS_INC1(sphere, 8);
     ...
     */
    static inline void box_distance_vectorized(int idx, float* res, float* bottom_left_x, float* bottom_left_y,
        float* bottom_left_z, float* extents_x, float* extents_y, float* extents_z, float* inv_rot[3][3],
        const vec from) {
        INS_INC1(box, 8);
     ...
     */
    static inline void torus_distance_vectorized(int idx, float* res, float* center_x, float* center_y, float* center_z,
        float* rad1, float* rad2, float* inv_rot[3][3], const vec from) {
        INS_INC1(torus, 8);
     ...
     */
    static inline void cone_distance_vectorized(int idx, float* res, float* center_x, float* center_y, float* center_z,
        float* rad1, float* rad2, float* height, float* inv_rot[3][3], const vec from) {
        INS_INC1(cone, 8);
     ...
     * Returns zero if early termination is possible, and a nonzero value otherwise.
     */
    static inline int cone_distance_short_vectorized(int idx, float* res, float* center_x, float* center_y,
        float* center_z, float* rad1, float* rad2, float* height, float* rad, float* inv_rot[3][3], const vec from,
        float current_min) {
        INS_INC1(cone, 8);
    ...
    static inline void octahedron_distance_vectorized(int idx, float* res, float* center_x, float* center_y,
        float* center_z, float* s_, float* inv_rot[3][3], const vec from) {
        INS_INC1(octa, 8);
     ...
     * Returns zero if early termination is possible, and a nonzero value otherwise.
     */
    static inline int octahedron_distance_short_vectorized(int idx, float* res, float* center_x, float* center_y,
        float* center_z, float* s_, float* inv_rot[3][3], const vec from, float current_min) {
        INS_INC1(octa, 8);
